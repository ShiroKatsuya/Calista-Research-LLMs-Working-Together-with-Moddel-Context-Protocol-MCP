        ...
        for round_idx in range(self.max_rounds):
            ...
            def extract_job_output(response: str) -> JobOutput:
                try:
                    ...
                    print(f"Failed to validate worker response as JSON: {e}")
                    ...
                    try:
                        ...
                        if json_match:
                            ...
                            return JobOutput.model_validate_json(json_str)
                        ...
                        print(f"Failed second attempt to extract JSON: {nested_e}")
                    
                    # If all else fails, create a default JobOutput with error info
                    return JobOutput(
                        explanation="The worker response could not be processed as valid JSON.",
                        citation=None,
                        answer="Error: Could not parse worker response as JSON. Please check the worker's output format."
                    )
