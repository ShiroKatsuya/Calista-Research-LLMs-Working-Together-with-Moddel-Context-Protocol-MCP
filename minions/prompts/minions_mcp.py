...
6. Make sure to escape special characters in strings properly (e.g., newlines become \\n)
7. Make sure your braces are balanced: each { must have a matching }

Example of a PROPERLY formatted response:
```json
{
  "explanation": "The document states the date clearly in the first paragraph.",
  "citation": "The meeting occurred on April 15, 2023 at the headquarters.",
  "answer": "April 15, 2023"
}
```

Example of NO RELEVANT INFORMATION found response:
```json
{
  "explanation": "The document does not contain information about the meeting date.",
  "citation": null,
  "answer": null
}
```

Output format (you **MUST** follow this format and MUST be valid JSON):
```json
{
"explanation": str,
"citation": List[str] or str or null,
"answer": List[str] or str or null
}
```
...
```json
{
  "explanation": "A concise statement of your reasoning",
  "citation": "A direct snippet of the text that supports your answer (or null if none)",
  "answer": "Your answer to the question (or null if no information found)"
}
```
...
1. ALL property names must be in double quotes: "explanation", "citation", "answer"
2. ALL string values must be in double quotes: "text here"
3. Use null (without quotes) instead of "None" for missing values
4. Do not include any comments or extra text outside the JSON
5. Make sure your JSON is valid and properly escaped
